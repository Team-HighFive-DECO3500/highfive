...
- Grudin, J. (1988). Why CSCW applications fail: Problems in the design and evaluation of organizational interfaces. In *Proceedings of CSCW '88* (pp. 85–93). ACM.  
...
- Oulasvirta, A., Tamminen, S., Roto, V., & Kuorelahti, M. (2005). VOGUE: A framework for discovering mobile user experience. In *CHI '05 Extended Abstracts* (pp. 1765–1768). ACM.  
